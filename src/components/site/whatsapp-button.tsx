...
export function WhatsAppButton() {
  ...
  return (
    <>
      ...
      <div
        className={`fixed bottom-6 right-4 sm:right-6 z-[60] transition-all duration-500 ${
      ...
      >
        ...
        >
          <div className={`${syne.className} bg-white rounded-xl shadow-lg px-4 py-3 text-sm text-zinc-700 whitespace-nowrap border border-zinc-100`}>
            <div className="flex items-center gap-2">
              ...
              Stel direct een vraag via WhatsApp
            </div>
            {/* Arrow */}
            <div className="absolute -bottom-2 right-6 w-4 h-4 bg-white border-r border-b border-zinc-100 transform rotate-45" />
          </div>
        </div>
        ...
        >
          <div className={`${syne.className} bg-white rounded-xl shadow-xl px-5 py-4 text-sm border border-zinc-100 w-64`}>
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                <div className="font-semibold text-foreground">Aboré Huidkliniek</div>
            ...
            <p className="text-zinc-600 text-xs mb-3">
              Heb je een vraag? Chat direct met ons team!
            </p>
            <div className="text-xs text-zinc-400">
              Reactietijd: meestal binnen 1 uur
            </div>
            {/* Arrow */}
            <div className="absolute -bottom-2 right-6 w-4 h-4 bg-white border-r border-b border-zinc-100 transform rotate-45" />
          </div>
        ...
        >
          {/* Button */}
          <div className="relative flex h-14 w-14 items-center justify-center rounded-full bg-green-500 shadow-lg shadow-green-500/30 transition-all duration-300 hover:scale-110 hover:shadow-xl hover:shadow-green-500/40">
