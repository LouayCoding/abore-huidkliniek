          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3 shrink-0">
              <a
                ...
                className={`${outfit.className} inline-flex items-center justify-center gap-2 rounded-full bg-primary px-8 py-3 text-white hover:bg-primary-hover transition-all shadow-lg whitespace-nowrap`}
              >
                Plan gratis consult
              </a>
              <a
                ...
                className={`${outfit.className} inline-flex items-center justify-center gap-2 rounded-full border-2 border-primary px-8 py-3 text-primary hover:bg-primary hover:text-white transition-all whitespace-nowrap`}
              >
          ...
          <div className="mx-auto max-w-4xl">
            <div className="grid md:grid-cols-2 gap-8 items-start">
              ...
              <div>
                ...
                <p className={`${outfit.className} text-lg text-zinc-600 mb-6`}>
                  {description}
                </p>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <span className={`${outfit.className} text-zinc-700`}>Gratis en vrijblijvend</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <svg className="h-6 w-6 text-primary shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                    </svg>
                    <span className={`${outfit.className} text-zinc-700`}>Persoonlijke huidanalyse</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <svg className="h-6 w-6 text-primary shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                    </svg>
                    <span className={`${outfit.className} text-zinc-700`}>Behandelplan op maat</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <svg className="h-6 w-6 text-primary shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                    </svg>
                    <span className={`${outfit.className} text-zinc-700`}>Direct antwoord op al je vragen</span>
                  </div>
                </div>
                ...
                <div className="mt-8 flex flex-col sm:flex-row gap-3">
                  <a
                    ...
                    className={`${outfit.className} inline-flex items-center justify-center gap-2 rounded-full border-2 border-primary px-6 py-3 text-primary hover:bg-primary hover:text-white transition-all`}
                  >
              ...
              <div className="p-8 rounded-2xl border border-zinc-200 bg-[#faf6ea]">
                ...
                <form className="space-y-4">
                  <div>
                    <label htmlFor="name" className={`${outfit.className} block text-sm font-medium text-foreground mb-2`}>
                      Naam *
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label htmlFor="phone" className={`${outfit.className} block text-sm font-medium text-foreground mb-2`}>
                      Telefoon *
                    </label>
                    <input
                      type="tel"
                  ...
                  <div>
                    <label htmlFor="treatment" className={`${outfit.className} block text-sm font-medium text-foreground mb-2`}>
                      Interesse in
                    </label>
                    <select
                      id="treatment"
                  ...
                  <button
                    type="submit"
                    className={`${outfit.className} w-full rounded-full bg-primary px-8 py-4 text-white hover:bg-primary-hover transition-all shadow-lg font-medium`}
                  >
                    Verstuur aanvraag
                  </button>
                  <p className={`${outfit.className} text-xs text-zinc-600 text-center`}>
