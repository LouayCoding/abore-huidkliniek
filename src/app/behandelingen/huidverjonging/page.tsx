              ...
              <div className="space-y-8">
                ...
                <div className="p-8 rounded-2xl border border-zinc-200 bg-white">
                  ...
                  <div className="flex items-center gap-6 text-sm">
                    <span className={`${syne.className} text-zinc-600`}>⏱️ 45-60 minuten</span>
                    <span className={`${syne.className} font-semibold text-primary`}>Vanaf €120</span>
                  </div>
                </div>
                ...
                <div className="p-8 rounded-2xl border border-zinc-200 bg-white">
                  ...
                  <div className="flex items-center gap-6 text-sm">
                    <span className={`${syne.className} text-zinc-600`}>⏱️ 60 minuten</span>
                    <span className={`${syne.className} font-semibold text-primary`}>Vanaf €100</span>
                  </div>
                </div>
                ...
                <div className="p-8 rounded-2xl border border-zinc-200 bg-white">
                  ...
                  <div className="flex items-center gap-6 text-sm">
                    ...
                    <span className={`${syne.className} font-semibold text-primary`}>Vanaf €150</span>
                  </div>
                </div>
                ...
                <div className="p-8 rounded-2xl border border-zinc-200 bg-white">
                  ...
                  <div className="flex items-center gap-6 text-sm">
                    <span className={`${syne.className} text-zinc-600`}>⏱️ 45 minuten</span>
                    <span className={`${syne.className} font-semibold text-primary`}>Vanaf €65</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mb-16 p-8 rounded-2xl bg-[#faf6ea]">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="flex items-start gap-3">
                  ...
                  <span className={`${syne.className} text-zinc-700`}>Fijne lijntjes en rimpels</span>
                </div>
                <div className="flex items-start gap-3">
                  <svg className="h-6 w-6 text-primary shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                  </svg>
                  <span className={`${syne.className} text-zinc-700`}>Huidverslapping</span>
                </div>
                <div className="flex items-start gap-3">
                  <svg className="h-6 w-6 text-primary shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                  </svg>
                  <span className={`${syne.className} text-zinc-700`}>Doffe, vermoeide huid</span>
                </div>
                <div className="flex items-start gap-3">
                  <svg className="h-6 w-6 text-primary shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                  </svg>
                  <span className={`${syne.className} text-zinc-700`}>Verlies van volume</span>
                </div>
                <div className="flex items-start gap-3">
                  <svg className="h-6 w-6 text-primary shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                  </svg>
                  <span className={`${syne.className} text-zinc-700`}>Grote poriën</span>
                </div>
                <div className="flex items-start gap-3">
                  <svg className="h-6 w-6 text-primary shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                  </svg>
                  <span className={`${syne.className} text-zinc-700`}>Ongelijkmatige huidtextuur</span>
                </div>
              </div>
            </div>
